      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          {contactLinks.map((link) => (
            ...
            >
              <link.icon size={16} className="text-accent group-hover:scale-110 transition-transform duration-300" />
        ...
        >
          ...
          <button
            type="submit"
            className="flex items-center gap-2 font-mono text-xs tracking-widest px-6 py-3 bg-action text-action-foreground rounded-lg hover:opacity-90 transition-all duration-300 shadow-[0_0_20px_hsl(24_85%_55%/0.15)]"
          >
